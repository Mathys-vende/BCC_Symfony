 ...
 */
final class Version20210515173056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, personne_id INT DEFAULT NULL, region VARCHAR(255) NOT NULL, departement VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, INDEX IDX_C35F0816A21BD112 (personne_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE encherir (id INT AUTO_INCREMENT NOT NULL, id_acheteur_id INT DEFAULT NULL, id_vente_id INT DEFAULT NULL, date DATETIME NOT NULL, prix_propose DOUBLE PRECISION NOT NULL, INDEX IDX_503B7C878EB576A8 (id_acheteur_id), INDEX IDX_503B7C872D1CFB9F (id_vente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE estimation (id INT AUTO_INCREMENT NOT NULL, id_lot_id INT DEFAULT NULL, id_commissaire_id INT DEFAULT NULL, description LONGTEXT NOT NULL, valeur DOUBLE PRECISION NOT NULL, date DATE NOT NULL, INDEX IDX_D05270248EFC101A (id_lot_id), INDEX IDX_D0527024CA8C2027 (id_commissaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordre_achat (id INT AUTO_INCREMENT NOT NULL, id_vente_id INT DEFAULT NULL, id_acheteur_id INT DEFAULT NULL, offre_acheteur DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, INDEX IDX_71306AD92D1CFB9F (id_vente_id), INDEX IDX_71306AD98EB576A8 (id_acheteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, id_lot_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_29A5EC278EFC101A (id_lot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vente (id INT AUTO_INCREMENT NOT NULL, id_vente_enchere_id INT DEFAULT NULL, id_lot_id INT DEFAULT NULL, date DATETIME NOT NULL, commission DOUBLE PRECISION NOT NULL, INDEX IDX_888A2A4C9F42C7DD (id_vente_enchere_id), INDEX IDX_888A2A4C8EFC101A (id_lot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vente_enchere (id INT AUTO_INCREMENT NOT NULL, id_salle_de_vente_id INT DEFAULT NULL, id_devise_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, date DATE NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_67DB1BEF6C22232 (id_salle_de_vente_id), INDEX IDX_67DB1BEF7471EC71 (id_devise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
